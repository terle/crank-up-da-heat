...
public class PageFragmentFour extends SherlockFragment implements OnClickListener, OnCheckedChangeListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View page = (View) inflater.inflate(R.layout.fragment_four, null);
	...
	public void onClick(View v) {
		...
		Intent appIntent = new Intent(parentActivity, MainActivity.class);
